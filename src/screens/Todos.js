...
export default function Todos() {
  ...
  const getTasks = async () => {
    try {
      const response = await axios.get("https://api.kontenbase.com/query/api/v1/4961609c-e314-4713-a06b-ffaf626319c7/Todo");
  ...
  const handleAddTask = async () => {
    if (task.length !== 0) {
      try {
        ...
        console.log(data);
        const response = await axios.post("https://api.kontenbase.com/query/api/v1/4961609c-e314-4713-a06b-ffaf626319c7/Todo", data);
